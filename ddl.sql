...
CREATE TABLE `SCREENING` (
	`time_id`	INT UNSIGNED	NOT NULL AUTO_INCREMENT	COMMENT '상영시간표ID',
	`movie_id`	VARCHAR(20)	NOT NULL	COMMENT '영화ID',
	`theater_id`	INT	NOT NULL AUTO_INCREMENT	COMMENT '상영관ID',
...
ALTER TABLE `SCREENING` ADD CONSTRAINT `PK_SCREENING` PRIMARY KEY (
	`time_id`
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
